...
Classify binary gender of a human voice sample by computing the frequency spectrum of the signal and extracting the Mel-frequency cepstral coefficients (MFCCs) from it.
